 ...
 * 
 */
@WebService(name = "TransakcijeWSDL", targetNamespace = "http://transakcije.nmb/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface TransakcijeWSDL {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "izvrsiNalog", targetNamespace = "http://transakcije.nmb/", className = "nmb.transakcije.IzvrsiNalog")
    @ResponseWrapper(localName = "izvrsiNalogResponse", targetNamespace = "http://transakcije.nmb/", className = "nmb.transakcije.IzvrsiNalogResponse")
    public String izvrsiNalog(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0,
